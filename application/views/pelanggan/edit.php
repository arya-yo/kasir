<div class="animate-fade-in">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h3 class="text-3xl font-bold text-gray-900 flex items-center gap-3">
                <i class="fas fa-user-edit text-cyan-600"></i> Edit Data Pelanggan
            </h3>
            <p class="text-gray-500 mt-2">Perbarui informasi pelanggan di bawah ini</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        <form method="post" action="<?php echo site_url('pelanggan/update/' . $pelanggan->PelangganID); ?>" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300" id="nama_pelanggan" name="nama_pelanggan" 
                       value="<?php echo $pelanggan->NamaPelanggan; ?>" placeholder="Nama pelanggan" required>
            </div>
            ...
            <div>
                ...
                <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 resize-none" id="alamat" name="alamat" rows="3"><?php echo $pelanggan->Alamat; ?></textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300" id="nomor_telepon" name="nomor_telepon" 
                       value="<?php echo $pelanggan->NomorTelepon; ?>" placeholder="Nomor telepon">
            </div>
