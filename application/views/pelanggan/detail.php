<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-cyan-50 to-cyan-100 border border-cyan-200 rounded-lg p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- Date -->
            <div>
                <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2"><i class="fas fa-calendar text-cyan-600 mr-1"></i>Tanggal Pembelian</label>
            ...
            <!-- Customer Name -->
            <div>
                <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2"><i class="fas fa-user-circle text-purple-600 mr-1"></i>Nama Pelanggan</label>
                <p class="text-lg font-bold text-gray-900"><?php echo $penjualan->NamaPelanggan; ?></p>
            </div>
        </div>
    </div>
